      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="relative">
          <select
            ...
            className="pl-10 pr-8 py-2 border border-[var(--border)] rounded-lg bg-[var(--surface)] text-[var(--foreground)] focus:ring-2 focus:ring-[#2563EB] focus:border-transparent appearance-none"
          >
