...
describe('Display Management', () => {
    ...
    it('should handle settings updates', async () => {
        ...
        const updateHandler = mockSocket.on.mock.calls.find((call) => call[0] === 'display:settings')[1];
    ...
    it('should handle status updates', async () => {
        ...
        const updateHandler = mockSocket.on.mock.calls.find((call) => call[0] === 'display:status')[1];
    ...
    it('should fetch display status', async () => {
        ...
        const statusHandler = mockSocket.on.mock.calls.find((call) => call[0] === 'display:status')[1];
    ...
    it('should fetch display settings', async () => {
        ...
        const settingsHandler = mockSocket.on.mock.calls.find((call) => call[0] === 'display:settings')[1];
