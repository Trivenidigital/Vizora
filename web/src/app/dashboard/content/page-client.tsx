...
export default function ContentClient() {
 ...
 <div className="text-sm font-medium text-[var(--foreground)] truncate" title={item.title}>
 {item.title}
 </div>
 {item.duration && (
 ...
 <div className="text-xs text-[var(--foreground-tertiary)]">{device.location || 'No location'}</div>
 </div>
 <span
