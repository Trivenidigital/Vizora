            ...
            const unsubscribe = on('device:status', {
                "DeviceStatusProvider.useEffect.unsubscribe": (data)=>{
                    ...
                    if (subscribers[data.deviceId]) {
                        subscribers[data.deviceId].forEach({
                            ...
                            data.forEach({
                                "DeviceStatusProvider.useEffect.unsubscribe": (update)=>{
                                    ...
                                    if (subscribers[update.deviceId]) {
                                        subscribers[update.deviceId].forEach({
                                            "DeviceStatusProvider.useEffect.unsubscribe": (callback)=>{
                                                callback(update);
                                            }
                                        }["DeviceStatusProvider.useEffect.unsubscribe"]);
...
_s(DeviceStatusProvider, "+0rNSICV+xLElWSCOTw3VFbVLlI=", false, function() {
    return [
...
//# sourceMappingURL=web_src_00728eba._.js.map