  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-6 pt-16 eh-grain">
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(37, 99, 235,0.08) 0%, rgba(30, 58, 138,0.03) 40%, transparent 65%)',
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(30, 58, 138,0.06) 0%, rgba(37, 99, 235,0.02) 40%, transparent 65%)',
      ...
      <div className="relative max-w-6xl mx-auto w-full">
        <div className="text-center mb-14">
          ...
          >
            ...
            <br />
            <span className="eh-gradient">One simple dashboard.</span>
          </h1>
          <p
        ...
        <Reveal delay={200}>
          ...
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 80px rgba(37, 99, 235,0.04), 0 0 160px rgba(30, 58, 138,0.03), 0 30px 60px rgba(0,0,0,0.3)',
            }}
          >
            {/* Topbar */}
            ...
            <div className="flex">
              {/* Sidebar */}
              <div className="hidden sm:block w-[180px] border-r py-3" style={{ borderColor: '#E5E7EB' }}>
                {[
              ...
              <div className="flex-1 p-4 sm:p-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mb-3.5">
                  {[
                    ...
                    <div key={s.label} className="rounded-lg p-3" style={{ background: '#111827', border: '1px solid #E5E7EB' }}>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {[
                    { name: 'Lobby Main', loc: 'HQ-F1', content: 'Welcome Video', online: true, gradient: 'rgba(37, 99, 235,0.06)' },
                    { name: 'Cafeteria', loc: 'HQ-F2', content: 'Daily Specials', online: true, gradient: 'rgba(30, 58, 138,0.06)' },
                    { name: 'Store Window', loc: 'RETAIL-DT', content: 'Summer Sale', online: false, gradient: 'rgba(139,92,246,0.06)' },
                  ].map((d) => (
                    <div key={d.name} className="rounded-lg p-2.5" style={{ background: '#111827', border: '1px solid #E5E7EB' }}>
                      ...
                      <div className="h-9 rounded flex items-center justify-center" style={{
                        ...
                        border: `1px solid ${d.online ? 'rgba(37, 99, 235,0.08)' : 'rgba(139,92,246,0.08)'}`,
                      }}>
