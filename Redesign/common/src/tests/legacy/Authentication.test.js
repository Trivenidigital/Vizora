...
const Authentication = () => _jsx("div", { children: "Authentication Component" });
const AuthProvider = ({ children }) => _jsx(_Fragment, { children: children });
const renderWithRouter = (ui) => {
    return render(_jsx(BrowserRouter, { children: _jsx(AuthProvider, { children: ui }) }));
};
