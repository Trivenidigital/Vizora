        ...
        <Reveal>
          <div className="text-center mb-14">
            ...
            >
              ...
              <span className="text-sm font-semibold" style={{ color: '#F9FAFB' }}>4.9/5</span>
              <span className="text-xs" style={{ color: '#6B7280' }}>from 200+ reviews</span>
            </div>
          </div>
        </Reveal>
          ...
          <Reveal className="lg:col-span-3">
            <div className="eh-card h-full rounded-xl p-8 flex flex-col">
              <div className="flex gap-0.5 mb-5">
                {Array.from({ length: 5 }).map((_, j) => (
                  <Star key={j} size={16} fill="#2563EB" style={{ color: '#2563EB' }} />
                ))}
              </div>
              <p className="text-base leading-relaxed mb-8 flex-1" style={{ color: '#E5E7EB' }}>
              ...
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, #2563EB, #1E3A8A)', color: '#111827' }}
                >
                  SC
                </div>
                <div>
            ...
            <Reveal delay={100}>
              <div className="eh-card rounded-xl p-6 flex flex-col">
                <div className="flex gap-0.5 mb-4">
                  {Array.from({ length: 5 }).map((_, j) => (
                    <Star key={j} size={13} fill="#2563EB" style={{ color: '#2563EB' }} />
                  ))}
                </div>
                <p className="text-sm leading-relaxed mb-5 flex-1" style={{ color: '#D1D5DB' }}>
                ...
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{ background: 'linear-gradient(135deg, #1E3A8A, #8B5CF6)', color: '#111827' }}
                  >
                    MW
                  </div>
                  <div>
            ...
            <Reveal delay={200}>
              <div className="eh-card rounded-xl p-6 flex flex-col">
                ...
                <div className="flex items-center gap-3">
                  <div
                    className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold"
                    style={{ background: 'linear-gradient(135deg, #8B5CF6, #2563EB)', color: '#111827' }}
                  >
                    JP
                  </div>
                  <div>
