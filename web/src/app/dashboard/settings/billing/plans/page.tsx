    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-50">Choose a Plan</h2>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 mt-8">
        ...
        <div className="space-y-4">
          <div>
            <h4 className="font-medium text-gray-900 dark:text-gray-50">Can I change plans later?</h4>
          ...
          <div>
            <h4 className="font-medium text-gray-900 dark:text-gray-50">What happens if I exceed my screen quota?</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          ...
          <div>
            <h4 className="font-medium text-gray-900 dark:text-gray-50">Is there a contract or commitment?</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              No, all plans are pay-as-you-go with no long-term contracts. You can cancel at any time.
            </p>
          </div>
          <div>
            <h4 className="font-medium text-gray-900 dark:text-gray-50">Do you offer refunds?</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 text-white">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            className="px-6 py-3 bg-white text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition whitespace-nowrap"
          >
            Contact Sales
          </a>
        </div>
