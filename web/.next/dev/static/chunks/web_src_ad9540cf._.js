    ...
    const loadStats = async ()=>{
        try {
            ...
            const [devicesRes, contentRes, playlistsRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getDisplays().catch(()=>({
                        data: []
                    })),
                __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getContent().catch(()=>({
                        data: []
                    })),
                __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getPlaylists().catch(()=>({
                        data: []
                    }))
            ]);
            const devices = devicesRes.data || devicesRes || [];
            const content = contentRes.data || contentRes || [];
            const playlists = playlistsRes.data || playlistsRes || [];
            setStats({
                devices: {
...
_s(DashboardPage, "DqqKI2Fwtwiy+R23A9u4iUSjPkI=", false, function() {
    return [
...
//# sourceMappingURL=web_src_ad9540cf._.js.map