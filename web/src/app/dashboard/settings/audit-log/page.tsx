    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-white text-gray-700 px-4 py-2 rounded-lg border border-gray-300 hover:bg-gray-50 transition font-medium shadow-sm flex items-center gap-2 disabled:opacity-50"
        >
                      ...
                      <tr>
                        <td colSpan={7} className="px-6 py-3 bg-gray-50">
                          <div className="text-xs">
                            ...
                            <pre className="bg-gray-100 p-3 rounded-lg overflow-x-auto text-gray-800 font-mono">
