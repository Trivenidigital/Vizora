...
export default function DevicesPage() {
 ...
 className="px-3 py-1.5 text-sm bg-[#00E5A0] text-[#061A21] rounded-lg hover:bg-[#00CC8E] transition font-medium"
 >
 Assign Playlist
 </button>
 <button
 ...
 className="px-3 py-1.5 text-sm text-[var(--foreground-secondary)] hover:text-[var(--foreground)] transition"
 >
 Clear
 </button>
 </div>
 ...
 <th
 className="px-6 py-3 text-left text-xs font-medium text-[var(--foreground-tertiary)] uppercase tracking-wider cursor-pointer hover:bg-[var(--surface-hover)] select-none"
 ...
 className="text-[#00E5A0] hover:text-[#00E5A0] hover:bg-[#00E5A0]/5 px-3 py-1 rounded transition font-medium"
 >
 Edit
 </button>
 <button
 ...
 className="relative inline-flex items-center px-4 py-2 border border-[var(--border)] text-sm font-medium rounded-md text-[var(--foreground-secondary)] bg-[var(--surface)] hover:bg-[var(--surface-hover)] disabled:opacity-50 disabled:cursor-not-allowed"
 >
 Previous
 </button>
 <button
 ...
 className="ml-3 relative inline-flex items-center px-4 py-2 border border-[var(--border)] text-sm font-medium rounded-md text-[var(--foreground-secondary)] bg-[var(--surface)] hover:bg-[var(--surface-hover)] disabled:opacity-50 disabled:cursor-not-allowed"
 >
 Next
 </button>
 </div>
 ...
 className="text-sm border-[var(--border)] rounded-md"
 >
 ...
 onClick={() => setCurrentPage(prev => Math.max(1, prev - 1))}
 disabled={currentPage === 1}
 className="relative inline-flex items-center px-2 py-2 rounded-l-md border border-[var(--border)] bg-[var(--surface)] text-sm font-medium text-[var(--foreground-tertiary)] hover:bg-[var(--surface-hover)] disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ← Previous
 </button>
 ...
 currentPage === pageNum
 ? 'z-10 bg-[#00E5A0]/5 border-[#00E5A0] text-[#00E5A0]'
 : 'bg-[var(--surface)] border-[var(--border)] text-[var(--foreground-tertiary)] hover:bg-[var(--surface-hover)]'
 }`}
 >
 {pageNum}
 </button>
 ...
 onClick={() => setCurrentPage(prev => Math.min(totalPages, prev + 1))}
 disabled={currentPage === totalPages}
 className="relative inline-flex items-center px-2 py-2 rounded-r-md border border-[var(--border)] bg-[var(--surface)] text-sm font-medium text-[var(--foreground-tertiary)] hover:bg-[var(--surface-hover)] disabled:opacity-50 disabled:cursor-not-allowed"
 >
 Next →
 </button>
 </nav>
 ...
 <div className="text-4xl font-bold text-[#00E5A0] tracking-widest">
 {pairingCode}
 </div>
 </div>
 ...
 className="w-full px-4 py-2 text-sm font-medium text-white bg-[#00E5A0] text-[#061A21] rounded-lg hover:bg-[#00CC8E] transition"
 >
 Done
 </button>
 </div>
 ...
 className="w-full px-4 py-2 border border-[var(--border)] rounded-lg bg-[var(--surface)] text-[var(--foreground)]"
 >
