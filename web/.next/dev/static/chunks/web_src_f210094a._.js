...
const getValidIconName = (name)=>{
    if (!name || !(name in __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$theme$2f$icons$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["iconMap"])) {
...
function DashboardPage() {
    ...
    const { deviceStatuses, isInitialized } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$context$2f$DeviceStatusContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeviceStatus"])();
    const [stats, setStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$11_$40$babel$2b$core$40$7$2e$_2c2d61b4ce987e30ba34ffda50ec852c$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        devices: {
            total: 0,
            online: 0
        },
            ...
            setStats({
                "DashboardPage.useEffect": (prev)=>({
                        ...
                        devices: {
                            ...
                            online: devicesList.filter({
                                "DashboardPage.useEffect": (d)=>d.status === 'online'
...
_s(DashboardPage, "8/qYpPH9ixRtdda2uA+4WMmm6SA=", false, function() {
    return [
